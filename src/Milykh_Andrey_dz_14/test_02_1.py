...
class Triangle:
    ...
    Traceback (most recent call last):
        ...
    task_02_ex.TriangleSideException: Недопустимое значение стороны треугольника: -9. Сторона треугольника должна быть больше нуля.
    >>> t2 = Triangle(4, 9, 5)
    Traceback (most recent call last):
        ...
    task_02_ex.TriangleExistException: Треугольника нет. b >= суммы других.
    >>> t3 = Triangle(6, 2, 5)
