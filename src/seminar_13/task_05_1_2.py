...
class Project:
    ...
    def add_user(self, user: User):
        if user.lvl < self.me.lvl:
            raise LevelError("Уровень ниже необходимого")
        self._users.add(user)  # если новый пользователь успешно
        return user  # добавился, возвращаем его
...
def main():
    ...
    print(f'{project.me = }')
    print(project.add_user(User(name='iddqd', idx=963, lvl=12)))  # 2:06:23
