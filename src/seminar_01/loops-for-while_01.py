...
# Выведем все чётные числа (как в прошлом примере), кроме тех, которые
# кратны 12.
#
num = float(input('Введите число: '))
STEP = 2
...
# ----------------------------------------------------------------------------
#
# Исторически сложилось, что для переменных, которые "считают арифметику"
# в цикле используются переменные i, j, k. Именно в таком порядке с учётом
# вложенности.
# Этой традиции более полувека. Так что смело продолжайте её и ваш код поймут.
# Например, так выглядят 3 вложенных цикла. Обратите внимание на отступы,
# которые показывают уровень вложенности
count = 10
...
# пример с животными. Будем выводить порядковый номер перед указанием животного.
animals = ['cat', 'dog', 'wolf', 'rat', 'dragon']
...
#   ● Функция enumerate() получила в качестве первого аргумента список животных.
#     Второй аргумент - стартовое значение счётчика, т.е. первое значение,
#     которое # попадёт в i.
#     Если второй аргумент не передать, нумерация начнётся с нуля.
#
# Важно! Функция enumerate позволяет перебирать только целые числа в порядке
# возрастания с шагом один.
#

# ----------------------------------------------------------------------------
# Задание
# ----------------------------------------------------------------------------
# Финальное задание с циклами. Перед вами пример программы. Попробуйте мысленно
# пройти по коду и напишите в чат финальное значение переменной data. У вас 2
# минуты на каждый вариант кода. Запускать программу не нужно.
#
# 1. Вариант кода 1.
data = 0
while data < 100:
